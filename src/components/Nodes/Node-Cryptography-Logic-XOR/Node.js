...
export default function NodeCryptographyLogicXOR({ data, id }) {
  // Data Processing
  ...
  const updateConnectedNodes = (value) => {
    ...
    targetNodes.forEach((node) => executeTargetNodeUpdate(node, value));
  };
    ...
    <div className={styles.node}>
      ...
      <form className={styles.node_form}>
        <div>
          <input
            id="optionA"
            className={styles.node_form_radio}
            name="case-type"
            type="radio"
            value="A"
            ...
            defaultChecked
          />
          <label className={styles.node_radio_label} htmlFor="optionA">
            Option A
          </label>
        </div>
        <div>
          <input
            ...
            onChange={handleRadioChange}
          />
          <label className={styles.node_radio_label} htmlFor="optionB">
            Option B
          </label>
        </div>
        <div>
          <input
            ...
            onChange={handleRadioChange}
          />
          <label className={styles.node_radio_label} htmlFor="nop">
            No Operation
          </label>
        </div>
      </form>
