...
export default function NodeCryptographyHashingSHA512({ data, id }) {
  // Data Processing
  const processValue = ((stringData) => {
    switch(componentRadioValue) {
      case "A":
        var CryptoJS = require("crypto-js");
        return CryptoJS.SHA512(stringData).toString()
      default:
        return stringData;
    }
  })
  ...
  return (
    <div className={styles.node}>
      ...
      />
      <label className={styles.node_label}>SHA-512</label>
